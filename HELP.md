...
* The original package name 'com.spendwise.spendwise-service' is invalid and this project uses 'com.spendwise.spendwise_service' instead.
...
```
$ docker run --rm -p 8080:8080 spendwise-service:0.0.1-SNAPSHOT
```
